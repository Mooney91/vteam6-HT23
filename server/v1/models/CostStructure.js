    ...
    createCostStructure: async function(req, res) {
        try {
            const sql = `
                ...
                VALUES (?)
            `;
            const rows = await pool.query(sql, req.body.CostStructureDesc, req.body.CostAmount);
        ...
        try {
            const sql = `
                ...
                WHERE
                    CostID = ?;
            `;
            const rows = await pool.query(sql, [req.body.CostDesc, req.body.CostAmount, req.params.id]);
