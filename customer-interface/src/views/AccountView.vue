...
<template>
    ...
    <div v-if="user">
        ...
        <p>Your FirstName: {{ user.FirstName }}</p><br>
        <p>Your LastName: {{ user.LastName }}</p><br>
        <p>Your Password: {{ user.Password }}</p><br>
        <p>Your Email: {{ user.Email }}</p><br>
        <p>Your AccountBalance: {{ user.AccountBalance }}</p><br>
        <p>Your PaymentType: {{ user.PaymentType }}</p><br>
        <p>Your Role: {{ user.Role }}</p><br>
    </div>
    <!--</div>-->
</template>
