  ...
  methods: {
    ...
    async fetchScooters() {
      try {
        ...
        // Initialise editForms with ScooterIDs as keys
    ...
    async updateChargingStation() {
      try {
        const response = await fetch(
          `${this.backend}/v1/scooter/${this.ScooterID}/park/${this.ChargingStationID}`,
          {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json',
    ...
    async updateParkingStation() {
      try {
        const response = await fetch(
          `${this.backend}/v1/scooter/${this.ScooterID}/park/${this.ParkingStationID}`,
          {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json',
    ...
    async unparkScooter(ScooterID, StationID) {
      ...
      try {
        const response = await fetch(
          `${this.backend}/v1/scooter/${ScooterID}/unpark/${StationID}`,
          {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json',
